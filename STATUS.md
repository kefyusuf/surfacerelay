...
These decisions must not be promoted merely because the design is written. Promotion is gated on verified T-602 implementation.
...
When implementation eventually begins, T-602 requires at minimum:
